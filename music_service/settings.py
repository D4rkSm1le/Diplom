...
ALLOWED_HOSTS = ['77.91.70.226', '127.0.0.1', 'localhost']
...
MIDDLEWARE = [
    ...
    'music.middleware.LoginRequiredMiddleware',
]
...
YANDEX_MUSIC_TOKEN = os.getenv('YANDEX_MUSIC_TOKEN', 'ваш_токен')
...
# Require login for all views by default
